(function(module){
  ...
  function createSchedule(o){
    ...
    var __minutesToString = function(minutes,cero){
      return ('{0|paddingLeft,00}:' + 
              '{1|paddingLeft,00}').format(
                Math.floor(minutes/60).toString(), 
                Math.ceil(minutes%60).toString()
             );
    }
    ...
    // Buttons      
    _that.Buttons = { 'Agenda': $.$('button', { className : 'pol-btn w3-button w3-white w3-right',
                                                type      : 'button', 
                                                innerHTML : 'A', 
                                                onclick   : function() { __toogle('Agenda'); } }),
                      'Day'   : $.$('button', { className : 'pol-btn w3-button w3-white w3-right',
                                                type      : 'button', 
                                                innerHTML : 'D', 
                                                onclick   : function() { __toogle('Day'); } }),
                      'Month' : $.$('button', { className : 'pol-btn w3-button w3-white w3-right', 
                                                type      : 'button',  
                                                innerHTML : 'M',                                                 
  ...
  module.ui = module.ui || {};
  module.ui.createSchedule = createSchedule;
